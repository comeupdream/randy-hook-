/** Time + date string helpers. All times are practice-local "HH:MM" 24h strings. */
...
/**
 * A practice-local date+time collapsed to a single minute count on a fixed
 ...
 * "how many minutes until this session starts" independent of server TZ.
 */
